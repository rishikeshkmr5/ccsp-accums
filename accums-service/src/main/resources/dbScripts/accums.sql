...
ALTER TABLE LEDGER_HEADER ALTER COLUMN LEDGER_ID SET GENERATED ALWAYS AS IDENTITY;	
...
ALTER TABLE LEDGER_ENTRY ALTER COLUMN LEDGER_LINE_ID SET GENERATED ALWAYS AS IDENTITY;	
...
ALTER TABLE LEDGER_SUMMARY ALTER COLUMN SUMMARY_ID SET GENERATED ALWAYS AS IDENTITY;	
