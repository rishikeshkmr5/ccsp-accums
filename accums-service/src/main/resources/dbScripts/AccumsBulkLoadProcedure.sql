...
BEGIN
	...
	WHILE START_INDEX < RECORDS_COUNT DO
		SET LDGR_ID = SEQ_LDGR_HDR.NEXTVAL;
		...
		VALUES (LDGR_ID, 'claim1002', 1, 10, 'Specialist Office Visit', CURRENT DATE - ((18 * 365) + RAND()*(47*365)) DAYS, CURRENT DATE - ((18 * 365) + RAND()*(47*365)) DAYS, 'INB', 'PPO', 10, rand()*100, MEMBER_ID, MEMBER_ID,'Dollars', 'xxx');
	
		WHILE  ENTRY_START_INDEX < 4 DO
			SET LDGR_ENTRY_ID = SEQ_LDGR_ENTRY.NEXTVAL;
			...
			INSERT INTO LDGR_SUM(LDGR_SUM_ID, ACCUM_TYP_NM, MBR_ID, NTWK_CD, NTWK_TIER_NM, END_DT, EFF_DT, PLN_ID, SUB_ID, AMT,MAX_AMT, MAX_VST_CNT, UOM_NM)
				values(SEQ_LDGR_SUM.NEXTVAL, ACCUM_TYPE, MEMBER_ID, 'INB', 'PPO', CURRENT TIMESTAMP, CURRENT DATE, 10, MEMBER_ID, rand()*100, 1000, 100, 'Dollars');
