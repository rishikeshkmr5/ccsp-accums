...
public class LedgerHeader {
	...
	public String toString() {
		return "LedgerHeader [LDGR_ID=" + LDGR_ID + ", DCN=" + DCN + ", CLM_LN_ID=" + CLM_LN_ID + ", SVC_ID=" + SVC_ID
				+ ", SVC_NM=" + SVC_NM + ", SVC_DT=" + SVC_DT + ", PROC_DT=" + PROC_DT + ", NTWK_CD=" + NTWK_CD
				+ ", NTWK_TIER_NM=" + NTWK_TIER_NM + ", PLN_ID=" + PLN_ID + ", ALWD_AMT=" + ALWD_AMT + ", MBR_ID="
				+ MBR_ID + ", SUB_ID=" + SUB_ID + ", UOM_NM=" + UOM_NM + ", ACCUM_TYP_NM=" + ACCUM_TYP_NM
